...
class OutcomeDataFraction extends Component {
      ...
      <Table aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell align="right">Fractional Odds (Click to Change)</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {this.state.outcomeData.map((row) => (
            <TableRow key={row.outcome.marketId}>
              ...
              <TableCell align="right">{row.outcome.price.decimal}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
...
export default OutcomeDataFraction;
